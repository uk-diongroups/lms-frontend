	...
	<Router basename={process.env.PUBLIC_URL} history={history}>
		<Suspense fallback={<PageLoader />}>
			<Switch>
				...
				{/* Patient Routes */}
				<AuthRoute exact path='/login' component={Login} layout={AuthLayout} />
				<AuthRoute exact path='/register' component={Register} layout={AuthLayout} />
				...
				<PrivateRoute exact path='/app' component={Dashboard} layout={DashboardLayout} />
